package com.tor.util.jar;
/*Задача: Загрузчик классов
Исходник: Запуск jar приложения из любого источника, удаленный запуск *.jar файлов [java, code #194, hits: 718, рейтинг: 7/3,5.06(162)]
Автор: неизвестный [добавлен: 02.05.2007]
...
/*Из командной строки задается jar url файла, т.е. адрес этого jar файла,
        который может представлять из себя как адрес в сети на http/ftp серверах,
        так и локальный путь в текущей файловой системе.
Далее jar средствами виртуальной машины загружается, определяется Main файл и
запускается с остальными аргументами, идущими из командной строки. */