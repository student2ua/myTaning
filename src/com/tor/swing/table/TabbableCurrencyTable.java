...
public class TabbableCurrencyTable {
    public static void main(String[] args) {
        ...
        TabEditTable tbl = new TabEditTable(new TestUpdatableCurrencyTableModel());
        ...
        StripedTableCellRenderer.installInColumn(tbl, 0, Color.lightGray, Color.white, null, null);
        StripedTableCellRenderer.installInColumn(tbl, 1, Color.lightGray, Color.white, null, null);
        StripedTableCellRenderer.installInColumn(tbl, 2, Color.lightGray, Color.white, null, null);
        StripedTableCellRenderer.installInColumn(tbl, 3, Color.lightGray, Color.white, null, null);
        ...
        tcm.getColumn(3).setCellRenderer(
                new HighlightRenderer(cmp, null, Color.pink, Color.black, Color.pink.darker(), Color.white));
...
class TabEditTable extends JTable {
    ...
    public TabEditTable(TableModel dm, TableColumnModel cm, ListSelectionModel sm) {
        super(dm, cm, sm);
    }
                ...
                if (viewEditingColumns[i] == column) {
                    ...
                    SwingUtilities.invokeLater(new Runnable() {
                        public void run() {
                            ...
                            ListSelectionModel columnSel = getColumnModel().getSelectionModel();
                            rowSel.setSelectionInterval(newRow, newRow);
                            columnSel.setSelectionInterval(newColumn, newColumn);
                        }
                    });
                    break;
                }
...
class CurrencyTableModel extends AbstractTableModel {
    ...
    protected Object[][] data = new Object[][]{
            {
                    new DataWithIcon("Belgian Franc", new ImageIcon(/*thisClass.getResource("belgium.gif")*/)), new Double(37.6460110), new Double(37.6508921), null},
            {
                    new DataWithIcon("British Pound", new ImageIcon(/*thisClass.getResource("gb.gif")*/)), new Double(0.6213051), new Double(0.6104102), null},
            {
                    new DataWithIcon("Canadian Dollar", new ImageIcon(/*thisClass.getResource("canada.gif")*/)), new Double(1.4651209), new Double(1.5011104), null},
            {
                    new DataWithIcon("French Franc", new ImageIcon(/*thisClass.getResource("france.gif")*/)), new Double(6.1060001), new Double(6.0100101), null},
            {
                    new DataWithIcon("Italian Lire", new ImageIcon(/*thisClass.getResource("italy.gif")*/)), new Double(1181.3668977), new Double(1182.104), null},
            {
                    new DataWithIcon("German Mark", new ImageIcon(/*thisClass.getResource("germany.gif")*/)), new Double(1.8191804), new Double(1.8223421), null},
            {
                    new DataWithIcon("Japanese Yen", new ImageIcon(/*thisClass.getResource("japan.gif")*/)), new Double(141.0815412), new Double(121.0040432), null}};
}