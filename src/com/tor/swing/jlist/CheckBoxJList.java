...
public class CheckBoxJList extends JList implements ListSelectionListener {
    ...
    public void setSelections(Collection numbers) {
        selectionCache.clear();
        selectionCache.addAll(numbers);
    ...
    public static void main(String[] args) {
        ...
        ((CheckBoxJList) list).setSelections(Arrays.asList(new Integer[]{new Integer(1), new Integer(3)}));
        ...
        frame.addWindowListener(new WindowAdapter() {
            ...
            private void doex() {
                System.out.println(((CheckBoxJList) list).getSelections());
            }
