...
class TreeDragSource implements DragSourceListener, DragGestureListener {
  ...
  TransferableTreeNode2 transferable;
  ...
  public void dragGestureRecognized(DragGestureEvent dge) {
    ...
    transferable = new TransferableTreeNode2(path);
...
//TransferableTreeNode2.java
//A Transferable TreePath to be used with Drag & Drop applications.
//

class TransferableTreeNode2 implements Transferable {
  ...
  public TransferableTreeNode2(TreePath tp) {
    path = tp;
  }
